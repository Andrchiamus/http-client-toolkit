...
For smarter caching based on server-provided `Cache-Control`, `ETag`, `Last-Modified`, and `Expires` headers, see the [Cache Headers (RFC 9111)](/http-client-toolkit/guides/cache-headers/) guide.
